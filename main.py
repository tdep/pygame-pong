...
def ball_animation():
    global ball_speed_x, ball_speed_y, player_score, opponent_score #really only a good solution for small programs - for larger applications use return statements or classes
    ball.x += ball_speed_x
    ball.y += ball_speed_y
